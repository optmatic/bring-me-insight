        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              <Link href="/">
                <h2 className="text-2xl font-sans font-light mb-4">BringMeInsight</h2>
              </Link>
            ...
            {/* Navigation Column */}
            <div>
              <h3 className="font-mono text-sm font-bold uppercase tracking-wider mb-4">NAVIGATION</h3>
            ...
            {/* Information Column */}
            <div>
              <h3 className="font-mono text-sm font-bold uppercase tracking-wider mb-4">INFORMATION</h3>
              <ul className="space-y-2">
                {[
                  "Subscribe",
                  "Contact Us",
                  ...
                  <li key={item}>
                    <Link href="#" className="font-mono text-xs text-white/70 hover:text-white">
                      {item}
                    </Link>
                  </li>
                ))}
