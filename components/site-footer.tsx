...
export function SiteFooter() {
  return (
    <footer className="bg-[#255F38] text-white py-12">
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              <Link href="/">
                <h2 className="text-2xl font-sans font-light mb-4">
                  BringMeInsight
                </h2>
              </Link>
              <p className="font-mono text-xs text-white/70 max-w-md mb-6">
                ...
                culture. We believe in the power of informed citizens.
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="font-mono text-xs text-white/50 mt-2 md:mt-0">
              Designed with integrity. Built for insight.
            </p>
          </div>
        </div>
      </div>
