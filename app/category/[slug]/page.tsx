        ...
        <section className="container mx-auto mt-8 px-4 md:px-6 lg:px-8">
          <div className="max-w-[1200px] mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex border border-charcoal/20">
                  <button
                    className={`p-2 ${viewMode === "grid" ? "bg-forest/10" : "bg-transparent"}`}
                  ...
                  <button
                    className={`p-2 ${viewMode === "list" ? "bg-forest/10" : "bg-transparent"}`}
                ...
                <Button variant="outline" size="sm" className="font-mono text-xs border-charcoal/20">
            ...
            <div className="mt-12 flex justify-center">
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" className="font-mono text-xs border-charcoal/20" disabled>
                  Previous
                </Button>
                {[1, 2, 3, 4, 5].map((page) => (
                  <Button
